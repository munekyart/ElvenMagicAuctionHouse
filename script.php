...
/**
* Script file of Serials component
*
* @package	Serials
* @subpackage	Installer
*/
class com_serialsInstallerScript
{
	/**
	...
	*/
	...
	{
		$adapter->getParent()->setRedirectURL('index.php?option=com_serials');
	...
	*/
	public function postflight($type, JAdapterInstance $adapter)
	{
		...
		$txtComponent = JText::_('COM_SERIALS');
