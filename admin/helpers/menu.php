...
defined('SERIALS_CPANEL_MAX_LENGTH') or define("SERIALS_CPANEL_MAX_LENGTH", null);
defined('SERIALS_CPANEL_ICON_SIZE') or define("SERIALS_CPANEL_ICON_SIZE", 48);
defined('SERIALS_CPANEL_BUTTON_WIDTH') or define("SERIALS_CPANEL_BUTTON_WIDTH", 100);
defined('SERIALS_CPANEL_BUTTON_HEIGHT') or define("SERIALS_CPANEL_BUTTON_HEIGHT", 100);
...
class SerialsCkHelperMenu
{
	...
	*/
	protected static function getXml()
	{
		...
		{
			if ($client == 'admin')
				$xmlFileBase = JPATH_ADMIN_SERIALS;
			else
				$xmlFileBase = JPATH_SITE_SERIALS;
	...
	*/
	...
	{
		$maxLength = SERIALS_CPANEL_MAX_LENGTH;
		$iconSize = SERIALS_CPANEL_ICON_SIZE;
		$buttonWidth = SERIALS_CPANEL_BUTTON_WIDTH;
		$buttonHeight = SERIALS_CPANEL_BUTTON_HEIGHT;
...
if (!class_exists('SerialsHelperMenu')){ class SerialsHelperMenu extends SerialsCkHelperMenu{} }
