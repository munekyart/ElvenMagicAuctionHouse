...
/**
* Ajax Class for Serials.
*
* @package	Serials
* @subpackage	Class
*/
class SerialsCkClassAjax extends JObject
{
	/**
	...
	*/
	public static function responseHook($options = array(), $version)
	{
		...
		switch(strtoupper($options['renderExceptions']))
		{
			...
			case 'HTML':
				$return->transaction->htmlExceptions = SerialsClassView::renderMessages('HTML');
				break;

			case 'TEXT':
				$return->transaction->rawExceptions = SerialsClassView::renderMessages('TEXT');
				break;
			...
			default:
				...
				else
				{
					...
					$return->transaction->exceptions = SerialsClassView::renderMessages(null);
...
if (!class_exists('SerialsClassAjax')){ class SerialsClassAjax extends SerialsCkClassAjax{} }
