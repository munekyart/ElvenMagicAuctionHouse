...
* @subpackage	Class
*/
class SerialsCkClassView extends CkJView
{
	/**
	...
	*/
	...
	{
		$this->addTemplatePath(JPATH_SERIALS . '/fork/views/' . $this->getName() . '/tmpl');
	}
...
if (!class_exists('SerialsClassView')){ class SerialsClassView extends SerialsCkClassView{} }
