...
/**
* HTML Raw View class for the Serials component
*
* @package	Serials
* @subpackage	Class
*/
class SerialsCkClassViewRaw extends SerialsClassView
{
	/**
	...
	*/
	public function outputField($name)
	{
		...
		JFormHelper::addFormPath(JPATH_SERIALS .'/models/forms');
...
if (!class_exists('SerialsClassViewRaw')){ class SerialsClassViewRaw extends SerialsCkClassViewRaw{} }
