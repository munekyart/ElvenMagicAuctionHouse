...
/**
* ORM Class for Serials.
*
* @package	Serials
* @subpackage	Class
*/
class SerialsCkClassModelOrm
{
	/**
	* Database.
	*
	...
	*/
	...
	{
		return new SerialsClassModelOrm($model);
	}
...
if (!class_exists('SerialsClassModelOrm')){ class SerialsClassModelOrm extends SerialsCkClassModelOrm{} }
