...
* @subpackage	
*/
class SerialsCkClassControllerList extends JControllerAdmin
{
	/**
	...
	*/
	public function getModel($name = '', $prefix = 'SerialsModel', $config = array('ignore_request' => true))
	{
		if (empty($name))
		{
...
if (!class_exists('SerialsClassControllerList')){ class SerialsClassControllerList extends SerialsCkClassControllerList{} }
