...
/**
* JLoader Class for Serials.
*
* @package	Serials
* @subpackage	Class
*/
class SerialsCkClassLoader extends JLoader
{
	/**
	...
	*/
	public static function setup($enablePsr = true, $enablePrefixes = true, $enableClasses = true, $enableComponentLoader = false)
	{
		...
		if ($enableComponentLoader)
			spl_autoload_register(array('SerialsClassLoader', 'load'));
	}
...
if (!class_exists('SerialsClassLoader')){ class SerialsClassLoader extends SerialsCkClassLoader{} }
