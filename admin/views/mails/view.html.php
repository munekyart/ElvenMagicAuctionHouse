...
class SerialsCkViewMails extends SerialsClassView
{
	...
	*/
	protected function displayDefault($tpl = null)
	{
		...
		// Toolbar
		JToolBarHelper::title(JText::_('SERIALS_LAYOUT_MAILS'), 'list');

		// New
		if ($model->canCreate())
			JToolBarHelper::addNew('mail.add', "SERIALS_JTOOLBAR_NEW");

		// Edit
		if ($model->canEdit())
			JToolBarHelper::editList('mail.edit', "SERIALS_JTOOLBAR_EDIT");
