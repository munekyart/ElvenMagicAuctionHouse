...
* @subpackage	Form
*/
class SerialsCkFormFieldRelation extends JFormFieldModel
{
	/**
	* The form field type.
	*
	...
	*/
	protected function getRelation()
	{
		...
		$model = CkJModel::getInstance($modelName, 'SerialsModel');
...
if (!class_exists('JFormFieldRelation')){ class JFormFieldRelation extends SerialsCkFormFieldRelation{} }
