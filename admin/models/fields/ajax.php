...
* @subpackage	Form
*/
class SerialsCkFormFieldAjax extends JFormField
{
	/**
	* Groups cache.
	*
	...
	protected function getConfig()
	{
		...
		switch($plugin)
		{
			...
			case 'field':
				...
				$config['groups'] = SerialsHelperForm::getElementGroups($this->element);
	...
	*/
	protected function getModel($model = null)
	{
		...
		return SerialsHelper::componentModel($model);
	}
...
if (!class_exists('JFormFieldAjax')){ class JFormFieldAjax extends SerialsCkFormFieldAjax{} }
