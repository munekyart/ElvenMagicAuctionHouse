...
* @subpackage	Form
*/
class SerialsCkFormFieldCkdirection extends SerialsClassFormField
{
	/**
	* The form field type.
	*
	...
	*/
	public function getInput()
	{
		...
		if ($dateFormat = $this->getOption('dateFormat'))
			SerialsHelperDates::listFormat($this->jdomOptions['list'], $this->getOption('labelKey'), $dateFormat);
...
if (!class_exists('JFormFieldCkdirection')){ class JFormFieldCkdirection extends SerialsCkFormFieldCkdirection{} }
