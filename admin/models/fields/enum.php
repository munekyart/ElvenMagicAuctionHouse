...
* @subpackage	Form
*/
class SerialsCkFormFieldEnum extends JFormFieldGroupedList
{
	/**
	* Items cache.
	*
	...
	*/
	protected function getItems()
	{
		if (!self::$_items)
		{
			...
			self::$_items = SerialsHelperEnum::_($enumName);
		}
...
if (!class_exists('JFormFieldEnum')){ class JFormFieldEnum extends SerialsCkFormFieldEnum{} }
