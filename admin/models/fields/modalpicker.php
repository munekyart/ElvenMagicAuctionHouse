...
* @subpackage	Form
*/
class SerialsCkFormFieldModalpicker extends JFormField
{
	/**
	* Extension name.
	*
	...
	*/
	protected function getSelectedLabel()
	{
		...
		$selectedItem = SerialsHelper::getData($model->getNameItem(), array(
...
if (!class_exists('JFormFieldModalpicker')){ class JFormFieldModalpicker extends SerialsCkFormFieldModalpicker{} }
