...
* @subpackage	Form
*/
class SerialsCkFormFieldCkcbrow extends SerialsClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCkcbrow')){ class JFormFieldCkcbrow extends SerialsCkFormFieldCkcbrow{} }
