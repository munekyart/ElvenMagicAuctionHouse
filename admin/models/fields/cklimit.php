...
* @subpackage	Form
*/
class SerialsCkFormFieldCklimit extends SerialsClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCklimit')){ class JFormFieldCklimit extends SerialsCkFormFieldCklimit{} }
