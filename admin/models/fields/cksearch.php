...
* @subpackage	Form
*/
class SerialsCkFormFieldCksearch extends SerialsClassFormField
{
	/**
	* The form field type.
	*
...
if (!class_exists('JFormFieldCksearch')){ class JFormFieldCksearch extends SerialsCkFormFieldCksearch{} }
