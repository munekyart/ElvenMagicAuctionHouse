...
*/
function SerialsCkBuildRoute(&$query)
{
	$view = null;
	$segments = array();
	if(isset($query['view']))
...
*/
function SerialsCkParseRoute($segments)
{
	$vars = array();
	$view = null;
...
*/
function SerialsCkParseSlug($slug, $model, $aliasKey)
{
	$parts = explode( ':', $slug );
	$id = $parts[0];
...
*/
function SerialsCkBuildSlug($id, $model, $aliasKey)
{
	$item = SerialsHelper::getData($model, array(
