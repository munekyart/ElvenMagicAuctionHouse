...
JHtml::addIncludePath(JPATH_ADMIN_SERIALS.'/helpers/html');
...
<div class="grid_wrapper">
	<table  class='table' id='grid-auctions'>
		<thead>
			<tr>
				<th>
					<?php echo JText::_("SERIALS_FIELD_AUCTIONDATETIME"); ?>
				</th>
		...
		for ($i=0, $n=count( $this->items ); $i < $n; $i++):
			...
			$pickValue = $row->id;
			$pickLabel = $this->escape(addslashes($row->datetime));
