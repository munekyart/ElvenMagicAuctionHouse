...
* @subpackage	Classes
*/
class SerialsCkModelMails extends SerialsClassModelList
{
	/**
	* Default item layout.
	*
	...
	*/
	protected function prepareQuery(&$query)
	{
		...
		// ORDERING
		$orderCol = $this->getState('list.ordering', 'goldsAttached');
...
if (!class_exists('SerialsModelMails')){ class SerialsModelMails extends SerialsCkModelMails{} }
