...
* @subpackage	Classes
*/
class SerialsCkModelAuctions extends SerialsClassModelList
{
	/**
	* Default item layout.
	*
	* @var array
	*/
	public $itemDefaultLayout = 'auction';
	...
	protected function prepareQuery(&$query)
	{
		...
		$this->orm(array(
			'search' => array(
				...
				// SEARCH : owner + currentBidOf + auctionDatetime
				'search' => array(
					'on' => array(
						'owner' => 'like',
						'currentBidOf' => 'like',
		...
		// ORDERING
		$orderCol = $this->getState('list.ordering', 'datetime');
...
if (!class_exists('SerialsModelAuctions')){ class SerialsModelAuctions extends SerialsCkModelAuctions{} }
